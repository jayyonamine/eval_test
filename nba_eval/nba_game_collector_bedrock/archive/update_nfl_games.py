"""
Update NFL games from last game date to specified end date
"""
...
def get_last_game_date(project_id: str, dataset_id: str = "nfl_data",
...
def update_nfl_games(end_date: str = "2025-12-05"):
    """Update NFL games from last game date to end_date"""
    ...
    print("=" * 70)
    print("NFL Game Data Incremental Update")
    print("=" * 70)

    # Get the last game date from BigQuery
    print(f"\nQuerying {GCP_PROJECT_ID}.nfl_data.game_results for most recent game...")
